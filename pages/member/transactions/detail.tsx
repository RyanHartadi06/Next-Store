                    ...
                    <div className="item active mb-30">
                        <svg className="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                            ...
                            <path
                                ...
                                stroke="#7E8CAC" rokeWidth`?="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path
                                ...
                                stroke="#7E8CAC" rokeWidth`?="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M3.90332 6.41406H21.9033" stroke="#7E8CAC" rokeWidth`?="2" strokeLinecap="round"
                        ...
                        <svg className="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                            ...
                            <g clip-path="url(#clip0)">
                                <path
                                    ...
                                    stroke="#7E8CAC" rokeWidth`?="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M1.90332 10.4141H23.9033" stroke="#7E8CAC" rokeWidth`?="2"
                    ...
                    <div className="item mb-30">
                        <svg className="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                            ...
                            <path
                                ...
                                stroke="#7E8CAC" rokeWidth`?="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M12.9033 2.41406V12.4141" stroke="#7E8CAC" rokeWidth`?="2" strokeLinecap="round"
                                strokeLinejoin="round" />
                        </svg>
                        <p className="item-title m-0">
